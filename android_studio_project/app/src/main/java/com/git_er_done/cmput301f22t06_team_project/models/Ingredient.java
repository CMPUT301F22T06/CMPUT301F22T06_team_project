...
public abstract class Ingredient {
    ...
    public static ArrayList<Location> locations = Location.createLocationList();
     ...
     */
    public Ingredient(String name, String desc, LocalDate best_before, Location location, String units,
